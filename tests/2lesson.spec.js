...
const URL = 'file:///C:/Users/frost/pw4/demo.html';
...
test('Поиск элемента по классу', async ({ page }) => {
   ...
   // Будет работать под тексту, но не по плейсхолдеру await page.locator('.el-input__inner').filter({ hasText: 'Email' }).click();
    await page
